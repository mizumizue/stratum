...
export class ConsoleReporter {
  public static printSummary(report: StratumDataPayload): void {
    ...
    console.log('\x1b[1m\x1b[36m                    Stratum Quality Report                  \x1b[0m');
  ...
  public static printCatalog(catalog: DecisionsCatalog, items?: DecisionsCatalogItem[]): void {
    ...
    console.log('\x1b[1m\x1b[35m       Stratum Decisions & Architecture Catalog             \x1b[0m');
  ...
  public static printDecisions(catalog: DecisionsCatalog): void {
    ...
    console.log('\x1b[1m\x1b[33m          Stratum Architectural Decisions (ADR & DSN)       \x1b[0m');
